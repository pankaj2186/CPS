...
exports.InputDescription = exports.ImagePreview = exports.PreviewContainer = exports.RemoveFileIcon = exports.FileMetaData = exports.PreviewList = exports.FilePreviewContainer = exports.UploadFileBtn = exports.DragDropText = exports.InputLabel = exports.FormField = exports.FileUploadContainer = void 0;
// @ts-ignore
const styled_components_1 = __importDefault(require("styled-components"));
exports.FileUploadContainer = styled_components_1.default.section `
  position: relative;
  margin: 25px 0 15px;
  border: ${(props) => props.isError ? '2px dotted #c9252d' : '2px dotted lightgray'};
  padding: 35px 20px;
  border-radius: 6px;
  display: flex;
...
`;
exports.FormField = styled_components_1.default.input.attrs((props) => ({ ...props })) `
  font-size: 18px;
  display: block;
  width: 100%;
  border: none;
...
`;
exports.InputLabel = styled_components_1.default.label.attrs((props) => ({ ...props })) `
  top: -21px;
  font-size: 13px;
  color: black;
  left: 0;
  position: absolute;
`;
exports.DragDropText = styled_components_1.default.p `
  ...
  margin-top: 0;
`;
exports.UploadFileBtn = styled_components_1.default.button `
...
`;
exports.FilePreviewContainer = styled_components_1.default.article `
  margin-bottom: 35px;
...
`;
exports.PreviewList = styled_components_1.default.section `
  display: flex;
  flex-wrap: wrap;
  margin-top: 10px;
...
`;
exports.FileMetaData = styled_components_1.default.div `
...
`;
exports.RemoveFileIcon = styled_components_1.default.i `
  cursor: pointer;
  &:hover {
    transform: scale(1.3);
  }
...
`;
exports.PreviewContainer = styled_components_1.default.section `
  padding: 0.25rem;
  width: 20%;
  height: 120px;
  border-radius: 6px;
...
`;
exports.ImagePreview = styled_components_1.default.img `
  border-radius: 6px;
  width: 100%;
  height: 100%;
`;
exports.InputDescription = styled_components_1.default.div.attrs((props) => ({ ...props })) `
  font-size: 12px;
  color: black;
  margin-top: -12px;
  color: ${(props) => props.isError ? '#c9252d' : ''};
`;
