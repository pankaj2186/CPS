...
const react_spectrum_2 = require("@adobe/react-spectrum");
...
const Panel = function (fieldset) {
    ...
    const layout = (0, af_core_1.getOrElse)(props, 'properties.afs:layout', {});
    const labelLayout = (0, af_core_1.getOrElse)(props, 'properties.afs:layout.label', {});
    ...
    if (props.visible) {
        return (react_1.default.createElement(react_spectrum_1.Flex, { direction: "column", gap: "10px", ...layout },
            react_1.default.createElement(react_spectrum_2.Text, { ...labelLayout }, localizedLabel),
